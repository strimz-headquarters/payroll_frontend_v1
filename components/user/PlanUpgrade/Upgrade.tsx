...
/**
 * The Upgrade component renders a dialog for upgrading a plan.
 *
 * The component renders a Tabs component with two tabs, one for monthly plans and one for yearly plans.
 * Each tab renders a section with a grid of plans, with each plan rendered as a div with a class of "h-[420px] rounded-[16px] border border-[#E5E7EB] bg-[#F9FAFB] cursor-pointer transition-all duration-200 group hover:bg-primary shadow-subCardShadow flex flex-col justify-between p-6".
 ...
 *
 * @return {JSX.Element} The upgrade plan dialog component.
 */
const Upgrade = () => {
    return (
        <Dialog>
            <DialogTrigger asChild>
                <button type="button" className='w-[112px] h-[32px] flex justify-center items-center rounded-[8px] bg-accent text-[#FFFFFF] font-poppins font-[500] shadow-joinWaitlistBtnShadow z-10 text-shadow text-[12px] capitalize'>
                    Upgrade plan
                </button>
            </DialogTrigger>
                            ...
                            <section className="w-full grid lg:grid-cols-3 md:grid-cols-3 lg:gap-8 md:gap-12 gap-8 px-4">
                                {
                                    plans.slice(1, 4).map((plan) => (
                                        <div
                                            key={plan.name}
                                            className="h-[420px] rounded-[16px] border border-[#E5E7EB] bg-[#F9FAFB] cursor-pointer transition-all duration-200 group hover:bg-primary shadow-subCardShadow flex flex-col justify-between p-6"
                                        >
