...
const HeroSection = () => {
    ...
    return (
        <section className='w-full min-h-screen lg:pt-[64px] pt-[56px] overflow-x-hidden bg-primary px-4 lg:px-4'>
            <main className="max-w-3xl mx-auto w-full flex flex-col items-center gap-6">
                <div className="w-full flex flex-col items-center gap-4">
                    <h1 className="font-sora font-[700] lg:text-[64px] md:text-[56px] text-[48px] lg:leading-[64px] md:leading-[56px] leading-[48px] text-white text-center">Pay your team in crypto with ease</h1>
