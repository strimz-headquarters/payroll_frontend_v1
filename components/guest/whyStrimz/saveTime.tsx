...
const SaveTime = () => {
    return (
        <div className="w-full grid md:grid-cols-2 gap-10">
            <div className='w-full bg-[#F9FAFB] border-[1px] border-[#E5E7EB] rounded-[16px] flex flex-col gap-8 md:p-8 p-6'>
                <h3 className="font-[600] font-sora text-[24px] text-primary">Save time and reduce workload</h3>
            ...
            <div className='w-full bg-[#F9FAFB] border-[1px] border-[#E5E7EB] rounded-[16px] flex flex-col gap-8 md:p-8 p-6'>
                <h3 className="font-[600] font-sora text-[24px] text-primary">Flexible Payroll for Any Team</h3>
