        ...
        <section className="w-full bg-primary md:py-20 py-6">
            <main className='w-full flex flex-col items-center'>
                <div className="w-full flex flex-col items-center gap-4 max-w-[600px] lg:px-0  px-6 mb-8">
                    ...
                    <p className='w-full max-w-[401px] font-poppins text-white font-[400] text-base leading-[28px] text-center'>Remote Teams → Borderless payroll without banking delays or restrictions. </p>
